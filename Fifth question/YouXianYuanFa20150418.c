...
#define NE 5
#define NJ 5                   //定义并输入基本参数
#define NZ 6
#define NPJ 0
#define NPF 2
#define NJ3 15
#define DD 9
#define E0 20.00E9            // 定义并输入常数
#define A0 0.5
#define I0 0.05
...
int jm[NE+1][3]={{0,0,0},{0,1,2},{0,2,4},{0,2,3},{0,3,4},{0,4,5}};
double gc[NE+1]={0.0,4.0,3.0,4.0,5.0,5.0};
double gj[NE+1]={0.0,90.0,0.0,90.0,-53.1301,-53.1301};
double mj[NE+1]={0.0,A0,A0,A0,2*A0,2*A0};
double gx[NE+1]={0.0,2*I0,2*I0,2*I0,3*I0,3*I0};
int zc[NZ+1]={0,1,2,3,13,14,15};
double pj[NPJ+1][3]={0.0,0.0,0.0};
double pf[NPF+1][5]={{0,0,0,0,0},{0.0,-800.0,4.0,1.0,1.0},{0.0,-800.0,4.0,3.0,1.0}};
