...
int jm[NE+1][3]={{0,0,0},{0,1,2},{0,2,3},{0,2,4},{0,3,5},{0,4,5},{0,6,4}};
double gc[NE+1]={0.0,6.0,6.0,12.0,12.0,6.0,6.0};
double gj[NE+1]={0.0,90.0,90.0,0.0,0.0,90.0,90.0};
double mj[NE+1]={0.0,2*A0,A0,2*A0,2*A0,A0,2*A0};
double gx[NE+1]={0.0,3*I0,2*I0,3*I0,3*I0,2*I0,3*I0};
int zc[NZ+1]={0,1,2,3,16,17,18};
double pj[NPJ+1][3]={{0.0,0.0,0.0}};
double pf[NPF+1][5]={{0,0,0,0,0},{0.0,40.0,3.0,4.0,2.0},{0.0,-40.0,9.0,4.0,2.0}};
