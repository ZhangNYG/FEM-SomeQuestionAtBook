...
int jm[NE+1][3]={{0,0,0},{0,1,2},{0,2,3}};
double gc[NE+1]={0.0,5.0,5.0};
double gj[NE+1]={0.0,0.0,-53.1301};
double mj[NE+1]={0.0,A0,A0};
double gx[NE+1]={0.0,I0,I0};
int zc[NZ+1]={0,1,2,3,7,8,9};
double pj[NPJ+1][3]={{0.0,0.0,0.0},{0.0,-5.0,4.0},{0.0,-3.0,6.0}};
double pf[NPF+1][5]={{0,0,0,0,0},{0,-4.8,5.0,1.0,1.0}};
