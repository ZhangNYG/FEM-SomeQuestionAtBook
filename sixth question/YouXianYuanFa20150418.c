...
#define NE 6
#define NJ 6                   //定义并输入基本参数
#define NZ 6
#define NPJ 4
#define NPF 3
#define NJ3 18
#define DD 12
#define E0 210.00E9            // 定义并输入常数
#define A0 10E-2
#define I0 1.4E-4
...
int jm[NE+1][3]={{0,0,0},{0,1,2},{0,2,3},{0,3,4},{0,2,5},{0,5,4},{0,6,5}};
double gc[NE+1]={0.0,4.0,4.0,8.0,8.0,4.0,4.0};
double gj[NE+1]={0.0,90.0,90.0,0.0,0.0,90.0,90.0};
double mj[NE+1]={0.0,A0,A0,1.5*A0,1.5*A0,A0,A0};
double gx[NE+1]={0.0,I0,I0,2*I0,2*I0,I0,I0};
int zc[NZ+1]={0,1,2,3,16,17,18};
double pj[NPJ+1][3]={{0.0,0.0,0.0},{0.0,1600.0,4.0},{0.0,1600.0,7.0},{0.0,-1600.0,8.0},{0.0,-1600.0,11.0}};
double pf[NPF+1][5]={{0,0,0,0,0},{0.0,1600.0,2.0,4.0,2.0},{0.0,1600.0,6.0,4.0,2.0},{0.0,-400.0,8.0,3.0,1.0}};
